...
#define Num_u 31					//...umax
#define Num_v 31						//...vmax
#define ORD_i 2					//...i
#define ORD_j 2					//...j
#define VER_i 5					//...Number of i Vertices
#define VER_j 5				//...Number of j Vertices
...
main()
{
	...
	double t_x[5][5], t_y[5][5], t_z[5][5];
	

	//...init BP Net
	BasePNet_ij_ksi[0][0] = -4.0; BasePNet_ij_eta[0][0] = 0.0; BasePNet_ij_zeta[0][0] = -1.5;
	BasePNet_ij_ksi[0][1] = -3.0; BasePNet_ij_eta[0][1] = 0.0; BasePNet_ij_zeta[0][1] = -0.3;
	BasePNet_ij_ksi[0][2] = -0.0; BasePNet_ij_eta[0][2] = 0.0; BasePNet_ij_zeta[0][2] = 0.0;
	BasePNet_ij_ksi[0][3] = -3.0; BasePNet_ij_eta[0][3] = 0.0; BasePNet_ij_zeta[0][3] = 0.3;
	BasePNet_ij_ksi[0][4] = -4.0; BasePNet_ij_eta[0][4] = 0.0; BasePNet_ij_zeta[0][4] = 1.5;

	BasePNet_ij_ksi[1][0] = -4.0; BasePNet_ij_eta[1][0] = 1.0; BasePNet_ij_zeta[1][0] = -1.5;
	BasePNet_ij_ksi[1][1] = -0.7; BasePNet_ij_eta[1][1] = 1.0; BasePNet_ij_zeta[1][1] = -1.3;
	BasePNet_ij_ksi[1][2] = -0.0; BasePNet_ij_eta[1][2] = 1.0; BasePNet_ij_zeta[1][2] = 0.0;
	BasePNet_ij_ksi[1][3] = -0.7; BasePNet_ij_eta[1][3] = 1.0; BasePNet_ij_zeta[1][3] = 1.3;
	BasePNet_ij_ksi[1][4] = -4.0; BasePNet_ij_eta[1][4] = 1.0; BasePNet_ij_zeta[1][4] = 1.5;

	BasePNet_ij_ksi[2][0] = -4.0; BasePNet_ij_eta[2][0] = 2.0; BasePNet_ij_zeta[2][0] = -1.7;
	BasePNet_ij_ksi[2][1] = -1.0; BasePNet_ij_eta[2][1] = 2.0; BasePNet_ij_zeta[2][1] = -1.4;
	BasePNet_ij_ksi[2][2] = -0.0; BasePNet_ij_eta[2][2] = 2.0; BasePNet_ij_zeta[2][2] = 0.0;
	BasePNet_ij_ksi[2][3] = -1.0; BasePNet_ij_eta[2][3] = 2.0; BasePNet_ij_zeta[2][3] = 1.4;
	BasePNet_ij_ksi[2][4] = -4.0; BasePNet_ij_eta[2][4] = 2.0; BasePNet_ij_zeta[2][4] = 1.7;

	BasePNet_ij_ksi[3][0] = -4.0; BasePNet_ij_eta[3][0] = 3.0; BasePNet_ij_zeta[3][0] = -1.9;
	BasePNet_ij_ksi[3][1] = -0.5; BasePNet_ij_eta[3][1] = 3.0; BasePNet_ij_zeta[3][1] = -1.7;
	BasePNet_ij_ksi[3][2] = -0.0; BasePNet_ij_eta[3][2] = 3.0; BasePNet_ij_zeta[3][2] = 0.0;
	BasePNet_ij_ksi[3][3] = -0.5; BasePNet_ij_eta[3][3] = 3.0; BasePNet_ij_zeta[3][3] = 1.7;	
	BasePNet_ij_ksi[3][4] = -4.0; BasePNet_ij_eta[3][4] = 3.0; BasePNet_ij_zeta[3][4] = 1.9;

	BasePNet_ij_ksi[4][0] = -4.0; BasePNet_ij_eta[4][0] = 3.5; BasePNet_ij_zeta[4][0] = -1.9;
	BasePNet_ij_ksi[4][1] = -0.5; BasePNet_ij_eta[4][1] = 3.5; BasePNet_ij_zeta[4][1] = -1.7;
	BasePNet_ij_ksi[4][2] = -0.0; BasePNet_ij_eta[4][2] = 3.5; BasePNet_ij_zeta[4][2] = 0.0;
	BasePNet_ij_ksi[4][3] = -0.5; BasePNet_ij_eta[4][3] = 3.5; BasePNet_ij_zeta[4][3] = 1.7;	
	BasePNet_ij_ksi[4][4] = -4.0; BasePNet_ij_eta[4][4] = 3.5; BasePNet_ij_zeta[4][4] = 1.9;
	//...show BP Net
	...
	//...start from Nu
	for(cout_i=0;cout_i<5;cout_i++)			//first row
	{
	...
	//	fprintf(test_v, "zone t=\"v\"\n");
		for(cout_j=0;cout_j<BP_j;cout_j++)
		{
			...
			t_x[cot][cout_j] = temp_x;
			t_y[cot][cout_j] = temp_y;
			t_z[cot][cout_j] = temp_z;
		//	fprintf(test_v, "%lf %lf %lf\n", t_x[cot][cout_j], t_y[cot][cout_j], t_z[cot][cout_j]);
		}
	}
...
//		printf("%lf\n", u[i]);	//......check result
	...
	for(j=0;j<Num_v;j++)
	{
		v[j] = (double)j/10.0;	//!!!!!!!!!! Here set number of u can change the precision(point number)!!!!!!!!!!
//		printf("%lf\n", v[j]);	//......check result
	}
	...
	//		fprintf(test_u, "%lf ", u[n_i]);
			for(p=0;p<=ORD_i;p++)
			{
				...
				{	
					...
					{
						N_u[p][i] = cacu_Nki(u[n_i], U[i], N_u[p-1][i], U[i+p], N_u[p-1][i+1], U[i+p+1], U[i+1]);
					}
				}
		...
		//	fprintf(test_v, "%lf ", v[n_j]);
			for(q=0;q<=ORD_j;q++)
			{
				...
				{	
					...
					{
						N_v[q][j] = cacu_Nki(v[n_j], V[j], N_v[q-1][j], V[j+q], N_v[q-1][j+1], V[j+q+1], V[j+1]);
					}
				}
	...
	for(n_i=0;n_i<Num_v;n_i++)
	{
		for(n_j=0;n_j<Num_v;n_j++)
		{
			...
			for(p=0;p<VER_i;p++)
			{
				for(q=0;q<VER_j;q++)
				{
					temp_x += t_x[p][q] * N_sig_u[n_i][p] * N_sig_v[n_j][q];
					temp_y += t_y[p][q] * N_sig_u[n_i][p] * N_sig_v[n_j][q];
					temp_z += t_z[p][q] * N_sig_u[n_i][p] * N_sig_v[n_j][q];
				}
			}
			x[n_i][n_j] = temp_x;
			y[n_i][n_j] = temp_y;
